...
namespace HSPI_ZWaveParametersTest
{
    ...
    public class SettingsPagesTest
    {
        ...
        public void CreateDefault()
        {
            ...
            {
                VeryHtmlValid(view.ToHtml());
            }

            VeryHtmlValid(page.ToHtml());
        ...
        public void DefaultValues(bool enableDefaultLogging, bool logToFileEnable)
        {
            ...
            settingsCollection.Add(SettingsPages.CreateDefault(enableDefaultLogging, logToFileEnable));
        ...
        {
            var settingsCollection = new SettingsCollection();
            settingsCollection.Add(SettingsPages.CreateDefault());
            var settingPages = new SettingsPages(settingsCollection);

            Assert.IsFalse(settingPages.OnSettingChange(new ToggleView("is", "name")));
        }
        ...
        {
            var settingsCollection = new SettingsCollection();
            settingsCollection.Add(SettingsPages.CreateDefault(enableDefaultLogging: initialValue));
            var settingPages = new SettingsPages(settingsCollection);

            ToggleView changedView = new ToggleView(SettingsPages.LoggingDebugId, "name", !initialValue);
        ...
        {
            var settingsCollection = new SettingsCollection();
            settingsCollection.Add(SettingsPages.CreateDefault(logToFileEnable: initialValue));
            var settingPages = new SettingsPages(settingsCollection);

            ToggleView changedView = new ToggleView(SettingsPages.LogToFileId, "name", !initialValue);
            Assert.IsTrue(settingPages.OnSettingChange(changedView));
